...
namespace KRAVANH\LabelMultiTranslate\Http\Controllers;
...
class LanguageTranslationController extends Controller
{
    ...
    */
    public function index()
    {
        ...
        return view('label-multi-translate::languages', compact('languages','columns','columnsCount'));
    ...
    */
    public function store(Request $request)
    {
        ...
        return redirect()->route('voyager.languages');
    }
